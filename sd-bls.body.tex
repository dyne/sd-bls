...
%mi piaceva usare la parola "proof of possession"
...
%"third party intercept a presentation". Eviterei "intercept"; dovrebbe essere al difuori del nostro threat model l'intercettazione. Noi teoricamente ipotiziamo sicuro il livello di trasporto. È il verifier che puo essere malevolo o potrebbe fare leakage per errore o perché attaccato
