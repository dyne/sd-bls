...
as lists of secret revocation keys $rev$. Lab measurements of the time
taken by a single proof verification process to operate on a growing
number of revocations is shown in figure \ref{fig:verifyrevocations}.
